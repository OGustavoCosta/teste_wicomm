...
function DefaultButton({ fill, text, link }: IDefaultButtonProps){
    return(
        <a type="submit" href={link} className={`group cursor-pointer relative h-12 overflow-hidden rounded-4xl px-8 py-2 duration-500 ${fill ? 'text-light' : 'text-dark border-2 hover:text-light'} border-dark w-fit flex items-center justify-center`}>
