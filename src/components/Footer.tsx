        ...
        <footer className="footer text-gray border-gray">
            <div className="footer__background">
                <section className="section flex flex-wrap pt-5 text-[12px]">
                    ...
                    <div className="grid grid-cols-5 w-full basis-[400px] grow h-fit">
                        <div className="section__nav col-span-5">
                        ...
                        <div className="p-4 border-[1px] flex flex-col gap-5 col-span-2">
                        ...
                        <div className="p-4 border-[1px] flex flex-col gap-2 col-span-3">
                            <h3 className="section__title uppercase font-bold">Certificados de Segurança</h3>
                            <ul className="section__list flex justify-center xsm:justify-between items-center flex-wrap gap-2">
                                <li className="section__item"><img className="section__icon saturate-0 hover:saturate-100 transition-all duration-300" src="\images\security\security-01.png" alt="" /></li>
                                <li className="section__item"><img className="section__icon saturate-0 hover:saturate-100 transition-all duration-300" src="\images\security\security-02.png" alt="ssl" /></li>
                                <li className="section__item"><img className="section__icon saturate-0 hover:saturate-100 transition-all duration-300" src="\images\security\security-03.png" alt="" /></li>
                            </ul>
                        </div>
                    </div>
                    <div className="grid w-full basis-[400px] grow grid-cols-2">
                        <div className="p-4 border-[1px] flex flex-col gap-2 row-span-2">
                        ...
                        <div className="p-4 border-[1px] flex flex-col gap-2 justify-center">
                            <h3 className="section__title uppercase font-bold">Contato</h3>
                            <p className="section__content">WhatsApp - (51) 9999-9999</p>
                            <p className="section__content">E-mail - ajuda@gat.com.br</p>
                        </div>
                        <div className="p-4 border-[1px] flex flex-col gap-2 justify-center">
